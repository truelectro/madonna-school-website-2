        ...
        <main className="min-h-screen pb-20 bg-gray-50">
            ...
            <section className="bg-[#051324] pt-40 pb-32 mb-20 text-white relative overflow-hidden">
                ...
                <div className="container mx-auto px-6 relative z-10 text-center">
                    ...
                    <h1 className="text-3xl md:text-8xl font-black mb-6 tracking-tight">{hallOfFameData.headerTitle || "Hall of Fame"}</h1>
                    ...
                    <div className="lg:w-1/2 space-y-10">
                        ...
                        <div className="bg-white p-10 rounded-[40px] shadow-lg border border-gray-100 group">
                            ...
                            <div className="bg-green-50 p-6 rounded-2xl flex items-start gap-4 border border-green-100">
                                ...
                                <p className="text-green-800 font-medium">{hallOfFameData.beceResultsText || "B.E.C.E. results have always been enviable, scoring nine (1)s with the highest raw scores."}</p>
                            </div>
                        </div>
